  ...
  return (
    ...
    <ToastContainer theme="dark" />
      <form onSubmit={onSubmitHandler} className="flex items-start flex-col gap-2 w-[80%] max-w-[600px] mt-24 px-2 mx-auto">
        ...
        <button type="submit" className="bg-orange-600 py-3 px-11 text-white rounded mt-4">Add Todo</button>

        <div className="relative overflow-x-auto mt-20 w-[100%] mx-auto">
